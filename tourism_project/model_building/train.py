...
Xtrain_path = "hf://datasets/VaishnaviPalyam/visit_with_us/data/Xtrain.csv"
Xtest_path = "hf://datasets/VaishnaviPalyam/visit_with_us/data/Xtest.csv"
ytrain_path = "hf://datasets/VaishnaviPalyam/visit_with_us/data/ytrain.csv"
ytest_path = "hf://datasets/VaishnaviPalyam/visit_with_us/data/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_travel_customer_model_v1.joblib"
    ...
    repo_id = "VaishnaviPalyam/travel_customer_model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_travel_customer_model_v1.joblib",
        path_in_repo="best_travel_customer_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
